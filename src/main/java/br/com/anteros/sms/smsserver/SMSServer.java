...
package br.com.anteros.sms.smsserver;
...
import br.com.anteros.sms.IQueueSendingNotification;
...
import br.com.anteros.sms.smsserver.gateways.AGateway;
import br.com.anteros.sms.smsserver.interfaces.Interface;
import br.com.anteros.sms.smsserver.interfaces.Interface.InterfaceTypes;
...
public class SMSServer
{
	...
	private void loadConfiguration() throws Exception
	{
		...
		try
		{
			...
			if (getProperties().getProperty("smsserver.balancer", "").length() > 0)
			{
				try
				{
					Class<?> c = Class.forName((getProperties().getProperty("smsserver.balancer", "").indexOf('.') == -1 ? "br.com.anteros.sms.balancing." : "") + getProperties().getProperty("smsserver.balancer", ""));
					Constructor<?> constructor = c.getConstructor();
					br.com.anteros.sms.balancing.LoadBalancer balancer = (br.com.anteros.sms.balancing.LoadBalancer) constructor.newInstance();
			...
			if (getProperties().getProperty("smsserver.router", "").length() > 0)
			{
				try
				{
					Class<?> c = Class.forName((getProperties().getProperty("smsserver.router", "").indexOf('.') == -1 ? "br.com.anteros.sms.routing." : "") + getProperties().getProperty("smsserver.router", ""));
					Constructor<?> constructor = c.getConstructor();
					br.com.anteros.sms.routing.Router router = (br.com.anteros.sms.routing.Router) constructor.newInstance();
			...
			for (int i = 0; i < Integer.MAX_VALUE; i++)
			{
				try
				{
					...
					Class<?> c = Class.forName((gtwClass.indexOf('.') == -1 ? "br.com.anteros.sms.smsserver.gateways." : "") + gtwClass);
			...
			for (int i = 0; i < Integer.MAX_VALUE; i++)
			{
				try
				{
					...
					Class<?> c = Class.forName((infClass.indexOf('.') == -1 ? "br.com.anteros.sms.smsserver.interfaces." : "") + infClass);
					Constructor<?> constructor = c.getConstructor(argsClass);
	...
	void sendMessages()
	{
		...
		for (br.com.anteros.sms.AGateway gtw : Service.getInstance().getGateways())
			if (gtw.isOutbound())
			{
	...
	{
		@Override
		public void process(br.com.anteros.sms.AGateway gateway, MessageTypes msgType, InboundMessage msg)
		{
			List<InboundMessage> msgList = new ArrayList<InboundMessage>();
			msgList.add(msg);
			for (Interface<? extends Object> inf : getInfList())
	...
	{
		@Override
		public void process(br.com.anteros.sms.AGateway gateway, br.com.anteros.sms.OutboundMessage msg)
		{
			try
			{
				for (Interface<? extends Object> inf : getInfList())
	...
	{
		@Override
		public void process(br.com.anteros.sms.AGateway gateway, String callerId)
		{
			try
			{
				for (Interface<? extends Object> inf : getInfList())
	...
	{
		@Override
		public void process(br.com.anteros.sms.AGateway gateway, OutboundMessage msg)
		{
	...
	{
		@Override
		public boolean process(br.com.anteros.sms.AGateway gateway, InboundMessage msg)
		{
			System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
