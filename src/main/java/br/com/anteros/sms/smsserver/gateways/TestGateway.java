...
/**
 * Gateway mapped to br.com.anteros.sms.test.TestGateway. Used for internal testing.
 */
public class TestGateway extends AGateway
{
	public TestGateway(String myGatewayId, Properties myProps, br.com.anteros.sms.smsserver.SMSServer myServer)
	{
	...
	public void create() throws Exception
	{
		...
		setGateway(new br.com.anteros.sms.test.TestGateway(getGatewayId()));
