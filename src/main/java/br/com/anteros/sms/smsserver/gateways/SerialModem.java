...
{
	public SerialModem(String myGatewayId, Properties myProps, br.com.anteros.sms.smsserver.SMSServer myServer)
	{
	...
	public void create() throws Exception
	{
		...
		setGateway(new br.com.anteros.sms.modem.SerialModemGateway(getGatewayId(), getProperties().getProperty(propName + "port"), Integer.parseInt(getProperties().getProperty(propName + "baudrate")), getProperties().getProperty(propName + "manufacturer"), getProperties().getProperty(propName + "model")));
		...
		((br.com.anteros.sms.modem.SerialModemGateway) getGateway()).setSimPin(getProperties().getProperty(propName + "pin"));
