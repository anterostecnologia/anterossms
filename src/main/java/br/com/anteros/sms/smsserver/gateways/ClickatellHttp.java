...
{
	public ClickatellHttp(String myGatewayId, Properties myProps, br.com.anteros.sms.smsserver.SMSServer myServer)
	{
	...
	public void create() throws Exception
	{
		...
		setGateway(new br.com.anteros.sms.http.ClickatellHTTPGateway(getGatewayId(), getProperties().getProperty(propName + "api_id"), getProperties().getProperty(propName + "username"), getProperties().getProperty(propName + "password")));
		if (getProperties().getProperty(propName + "secure").equalsIgnoreCase("yes")) ((br.com.anteros.sms.http.ClickatellHTTPGateway) getGateway()).setSecure((true));
