...
import br.com.anteros.sms.modem.ModemGateway.IPProtocols;
...
{
	public IPModem(String myGatewayId, Properties myProps, br.com.anteros.sms.smsserver.SMSServer myServer)
	{
	...
	public void create() throws Exception
	{
		...
		setGateway(new br.com.anteros.sms.modem.IPModemGateway(getGatewayId(), getProperties().getProperty(propName + "ip"), Integer.parseInt(getProperties().getProperty(propName + "port")), getProperties().getProperty(propName + "manufacturer"), getProperties().getProperty(propName + "model")));
		...
		((br.com.anteros.sms.modem.IPModemGateway) getGateway()).setSimPin(getProperties().getProperty(propName + "pin"));
		...
		((br.com.anteros.sms.modem.ModemGateway) getGateway()).setCustomInitString(getProperties().getProperty(propName + "init_string", ""));
		if (getProperties().getProperty(propName + "smsc_number", "").length() > 0) ((br.com.anteros.sms.modem.ModemGateway) getGateway()).setSmscNumber(getProperties().getProperty(propName + "smsc_number"));
	}
}
