...
import br.com.anteros.sms.helper.CommPortIdentifier;
import br.com.anteros.sms.helper.Logger;
import br.com.anteros.sms.helper.SerialPort;
import br.com.anteros.sms.helper.SerialPortEvent;
import br.com.anteros.sms.helper.SerialPortEventListener;
...
class SerialModemDriver extends AModemDriver implements SerialPortEventListener
{
	...
	protected void connectPort() throws GatewayException, IOException, InterruptedException
	{
		...
		try
		{
			...
			setSerialPort(getPortId().open("br.com.anteros.sms", 1971));
