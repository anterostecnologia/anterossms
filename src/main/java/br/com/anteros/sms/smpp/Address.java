...
public class Address
{
	...
	{
		UNKNOWN((byte) 0x00), INTERNATIONAL((byte) 0x01), NATIONAL((byte) 0x02), NETWORK_SPECIFIC((byte) 0x03), SUBSCRIBER_NUMBER((byte) 0x04), ALPHANUMERIC((byte) 0x05), ABBREVIATED((byte) 0x06);
		private byte value;
	...
	{
		UNKNOWN((byte) 0x00), ISDN((byte) 0x01), DATA((byte) 0x02), TELEX((byte) 0x03), LAND_MOBILE((byte) 0x04), NATIONAL((byte) 0x08), PRIVATE((byte) 0x09), ERMES((byte) 0x10), INTERNET((byte) 0x14), WAP((byte) 0x18);
		private byte value;
		 ...
		 *             <tt>value</tt>.
		 */
		public static NumberingPlanIndicator valueOf(byte value) throws IllegalArgumentException
		{
