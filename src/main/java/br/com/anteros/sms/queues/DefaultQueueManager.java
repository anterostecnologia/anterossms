...
public class DefaultQueueManager extends AbstractQueueManager
{
	...
	/* (non-Javadoc)
	 * @see br.com.anteros.sms.queues.AbstractQueueManager#queueMessage(br.com.anteros.sms.OutboundMessage)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.com.anteros.sms.queues.AbstractQueueManager#removePendingMessage(br.com.anteros.sms.OutboundMessage)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.com.anteros.sms.queues.AbstractQueueManager#removePendingMessage(java.lang.String)
	 */
	@Override
